      ...
      tabItem(tabName= "tpestimation",
              fluidPage(
                box(
                  ...
                  numericInput(inputId='select_max_iter',label="Choose maximum number of iterations",min=10,max=1000,value=5000),
                  uiOutput('select_stepsize_init_element'),
                  numericInput(inputId='select_stepsize_scaler',label='Choose stepsize scaler',min=.0001,max=1,value=.1),
                ...
                uiOutput("tp_last_1"),
                uiOutput("tp_last_2"),
                box(title = 'Plot of MSE per fold, per model, in each timepoint',
                    width=8,
