...
After running either file, the application should run without any other issues. Should any problems still occur, the application is still available at <REDACTED> for testing. Note that the version on the website does not allow for debugging output. 
